# 1 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
struct dma_attrs;
# 5 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 6 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 7 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 8 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 9 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 10 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 11 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 5 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.h" 2
...
# 14 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 15 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2
...
# 17 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c" 2



QDMA_DbgCounters_T counters[16][8] ;
...
static int __st_prepare_rx_buff(QDMA_RxMsg_T *pRxMsg, struct sk_buff *skb)
{
 ...
 if(pRxMsg == ((void *)0)) {
  pRxMsg = (QDMA_RxMsg_T *)kmalloc(sizeof(QDMA_RxMsg_T), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u))) ;
  if(pRxMsg == ((void *)0)) {
   ret = -12 ;
   goto err ;
  }
...
static int qdma_st_packet_gen(uint channel, uint queue, uint npackets, uint lens, unchar pattern)
{
 ...
 { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "Loopback test packets=%d, lens=%d, jiffies:%d \n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 188, npackets, lens, (uint)jiffies) ; };

 for (i=0 ; i<npackets ; i++) {
  times = 2 ;
  pTxMsg = (QDMA_TxMsg_T *)kmalloc(sizeof(QDMA_TxMsg_T), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if(pTxMsg == ((void *)0)) {
   continue ;
  } else {
   memset(pTxMsg, 0, sizeof(QDMA_TxMsg_T)) ;
   pTxMsg->channel = (channel == 16)?(random32() % 16):channel;
   pTxMsg->queue = (queue == 8)?(random32() % 8):queue;
   pTxMsg->fport = 0x2 ;
  }

  skb = dev_alloc_skb((2000)+2);
  if (skb == ((void *)0))
   continue;
  ...
  do {
   if(i%10000 == 9999) {
    { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "TX PKT: there are %d packets has been sent.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 269, i+1) ; } ;
    msleep(0) ;
   }
 ...
 { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "TX PKT: there are %d packets has been sent.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 287, i) ; };
...
static int qdma_st_cb_rx_packet(void *msg_p, uint msg_len, struct sk_buff *skb, uint rx_len)
{
 ...
 consume_skb(skb);
 __st_prepare_rx_buff(pRxMsg, ((void *)0)) ;

 if((idx%10000) == 0) {
  { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "RX PKT: the %d packet has been received. jiffies:%d\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 369, idx, (uint)jiffies) ; };
 }
...
# 419 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c"
static void qdma_st_csr_txqos(uint times)
{
 int t, i, j ;
 QDMA_TxQosScheduler_T setTxQos[16] ;
...
{
 int t, i ;
 QDMA_TcontTrtcm_T setGponTrtcm[16] ;
...
# 755 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c"
static int qdma_st_write_proc(struct file *file, const char *buffer, unsigned long count, void *data)
{
 ...
 packets = simple_strtol(subcmd, ((void *)0), 0) ;
 lens = value ;
 ...
 if(!strcmp(cmd, "init")) {
  ...
  do {
   if(__st_prepare_rx_buff(((void *)0), ((void *)0)) != 0) {
    break ;
   }
   dbg++ ;
  ...
  if(!strcmp(subcmd, "umac")) {
   ...
   { uint t = ioread32((void *)(0xBFB51500)); iowrite32(((t&~(0x1F<<20))|((0<<20)&0x1F<<20)), (void *)(0xBFB51500)); } ;
  } else {
  ...
  gpQdmaPriv->devCfg.dbgLevel = 1 ;
     ...
     { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "Prepare %d receive packet buffers in QDMA init stage.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 812, dbg) ; } ;
  { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "CSR info: INFO:%.8x, GLG:%.8x, INT_MASK:%.8x, TX_DSCP_BASE:%.8x, RX_DSCP_BASE:%.8x\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 818, ioread32((void *)((base+0x0000))), ioread32((void *)((base+0x0004))), qdmaGetIntMask(base), ioread32((void *)((base+0x0008))), ioread32((void *)((base+0x000C)))) ; } ;





  { if(gpQdmaPriv->devCfg.dbgLevel >= DBG_ST) printk("%s [%d]: " "CSR info: RX_CPU_IDX:%d, RX_DMA_IDX:%d, TX_CPU_IDX:%d, TX_DMA_IDX:%d\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c", '/')+1, 823, ((ioread32((void *)((base+0x0018))) & (0xFFF<<(0))) >> (0)), ((ioread32((void *)((base+0x001C))) & (0xFFF<<(0))) >> (0)), ((ioread32((void *)((base+0x0010))) & (0xFFF<<(0))) >> (0)), ((ioread32((void *)((base+0x0014))) & (0xFFF<<(0))) >> (0))) ; } ;




 }
# 836 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c"
 else if(!strcmp(cmd, "csr1")) {
  uint oldInt = qdmaGetIntMask(base) ;
  uint channel = random32() % 16 ;
  uint queue = random32() % 8 ;

  qdmaSetIntMask(base, ((1<<0)|(1<<3)|(1<<2))) ;

  memset(counters, 0, sizeof(QDMA_DbgCounters_T)*16*8) ;
  ...
  printk("INT_CSR:%.8x, Packets:%d, NO_TX_DSCP_INT Count:%d, NO_RX_DSCP_INT Count:%d\n\n", ioread32((void *)((base+0x0050))), packets, gpQdmaPriv->counters.intNoTxDscp, gpQdmaPriv->counters.intNoRxDscp) ;
  __st_print_counters() ;
  ...
  qdmaSetIntMask(base, ((1<<0)|(1<<8))) ;

  memset(counters, 0, sizeof(QDMA_DbgCounters_T)*16*8) ;
  gpQdmaPriv->counters.intNoLinkDscp = 0 ;
  qdma_st_packet_gen(channel, queue, packets, lens, 0x01) ;
  qdma_bm_receive_packets(0) ;
  printk("INT_CSR:%.8x, Packets:%d, NO_LINK_DSCP_INT Count:%d\n\n", ioread32((void *)((base+0x0050))), packets, gpQdmaPriv->counters.intNoLinkDscp) ;
  __st_print_counters() ;
  ...
  uint oldInt = qdmaGetIntMask(base) ;
  uint oldGlb = ioread32((void *)((base+0x0004))) ;
  uint channel = random32() % 16 ;
  uint queue = random32() % 8 ;
  uint csr[2] = {(oldGlb&=~(1<<7)), (oldGlb|(1<<7))} ;

  qdmaSetIntMask(base, ((1<<0)|(1<<13)|(1<<12))) ;
  iowrite32((oldGlb&=~(1<<7)), (void *)((base+0x0004))) ;
  ...
  for(i=0 ; i<2 ; i++) {
   iowrite32(csr[i], (void *)((base+0x0004))) ;
   ...
   printk("CHECK_DONE:%d, GLB_CSR:%.8x, INT_CSR:%.8x, RX_COHERENT_INT Count:%d, TX_COHERENT_INT Count:%d\n\n", i, ioread32((void *)((base+0x0004))), ioread32((void *)((base+0x0050))), gpQdmaPriv->counters.intRxCoherent, gpQdmaPriv->counters.intTxCoherent) ;
  }
  __st_print_counters() ;
  ...
  iowrite32(0xFFFFFFFF, (void *)((base+0x0050))) ;
  iowrite32(oldGlb, (void *)((base+0x0004))) ;
  qdmaSetIntMask(base, oldInt) ;
 }

 else if(!strcmp(cmd, "csr4")) {
  uint oldDly = ioread32((void *)((base+0x0058))) ;
  uint channel = random32() % 16 ;
  uint queue = random32() % 8 ;
  uint csr[5] = {0, ((1<<15) | (25<<(8)) | (0<<(0))),
        ((1<<15) | (50<<(8)) | (0<<(0))),
        ((1<<15) | (50<<(8)) | (80<<(0))),
        ((1<<15) | (50<<(8)) | (200<<(0)))} ;

  for(i=0 ; i<5 ; i++) {
   iowrite32(csr[i], (void *)((base+0x0058))) ;
   ...
   printk("Rx Delay Pkt:%d, Time:%d*20us, DlyCSR:%.8x, Packets:%d, RX_INT Count:%d\n\n",
          ((ioread32((void *)((base+0x0058)))&(0x7F<<(8)))>>(8)) ,
          ((ioread32((void *)((base+0x0058)))&(0xFF<<(0)))>>(0)),
          ioread32((void *)((base+0x0058))), packets, gpQdmaPriv->counters.intRxDone) ;
   msleep(2000) ;
  }
  iowrite32(oldDly, (void *)((base+0x0058))) ;
 }
  ...
  uint channel = random32() % 16 ;
  uint queue = random32() % 8 ;
  uint csr[5] = {0, ((1<<31) | (25<<(24)) | (0<<(16))),
        ((1<<31) | (50<<(24)) | (0<<(16))),
        ((1<<31) | (50<<(24)) | (80<<(16))),
        ((1<<31) | (50<<(24)) | (200<<(16)))} ;

  iowrite32((oldGlb&=~(1<<19)), (void *)((base+0x0004))) ;
  for(i=0 ; i<5 ; i++) {
   iowrite32(csr[i], (void *)((base+0x0058))) ;
   ...
   printk("Tx Delay Pkt:%d, Time:%d*20us, DlyCSR:%.8x, Packets:%d, TX_INT Count:%d\n\n",
          ((ioread32((void *)((base+0x0058)))&(0x7F<<(24)))>>(24)) ,
          ((ioread32((void *)((base+0x0058)))&(0xFF<<(16)))>>(16)),
          ioread32((void *)((base+0x0058))), packets, gpQdmaPriv->counters.intTxDone) ;
   msleep(2000) ;
  }
  iowrite32(oldGlb, (void *)((base+0x0004))) ;
  iowrite32(oldDly, (void *)((base+0x0058))) ;
  ...
  if(!strcmp(cmd, "tc6") || !strcmp(cmd, "tcall")) {
   ...
   depth = ((ioread32((void *)((base+0x0064))) & (0xFFF<<(0))) >> (0)) ;
   qdmaSetIntMask(base, ((1<<1)|(1<<9))) ;
   ...
   for(i=0 ; i<3 ; i++) {
    ...
    { uint t = ioread32((void *)((base+0x0064))); iowrite32(((t&~((0xFFF<<(0))))|((grade[i]<<(0))&(0xFFF<<(0)))), (void *)((base+0x0064))); } ;
    printk("Case 6-%d: IRQ Queue Depth:%d, Pattern:RAND, Lens:RAND, Packets:%d\n", i+1, grade[i], packets) ;
    qdma_st_packet_gen(16, 8, packets/3, 0, 0x01) ;
   ...
   { uint t = ioread32((void *)((base+0x0064))); iowrite32(((t&~((0xFFF<<(0))))|((depth<<(0))&(0xFFF<<(0)))), (void *)((base+0x0064))); } ;
   qdmaSetIntMask(base, oldInt) ;
  }
# 1053 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dvt.c"
  ...
  if(!strcmp(cmd, "tc4") || !strcmp(cmd, "tcall")) {
   unchar bs[4] = {(0x0), (0x1), (0x2), (0x3)} ;

   memset(counters, 0, sizeof(QDMA_DbgCounters_T)*16*8) ;
   printk("Case 4: Pattern:RAND, Lens:RAND, Burst Size:4, 8, 16, 32, Packets:%d\n", packets) ;
   for(i=0 ; i<4 ; i++) {
    { uint t = ioread32((void *)((base+0x0004))); iowrite32(((t&~((0x3<<(4))))|((bs[i]<<(4))&(0x3<<(4)))), (void *)((base+0x0004))); } ;
    msleep(1000) ;

    qdma_st_packet_gen(16, 8, packets/4, 0, 0x01) ;
    msleep(1000) ;
    if(__st_check_counters() == 0) {
     printk("Burst Size:%d, Packets:%d, Test Result:Pass\n\n", ((ioread32((void *)((base+0x0004))) & (0x3<<(4))) >> (4)), packets/4) ;
    } else {
  ...
  if(!strcmp(cmd, "tc5") || !strcmp(cmd, "tcall")) {
   ...
   for(i=0 ; i<5 ; i++) {
    ...
    qdma_st_packet_gen(16, 8, packets/5, 0, 0x01) ;


    gpQdmaPriv->devCfg.countDown = 1 ;
    gpQdmaPriv->devCfg.waitTxMaxNums = 1 ;
    qdma_st_packet_gen(16, 8, 1, 0, 0x01) ;
    msleep(1000) ;
    if(__st_check_counters() == 0) {
     printk("Grade Nums:%d, Packets:%d, Test Result:Pass\n\n", grade[i], packets/5) ;
    } else {
...
int qdma_dvt_init(void)
{
 ...
 qdma_proc = create_proc_entry("qdma/self_test", 0, ((void *)0));
 if(qdma_proc) {
...
int qdma_dvt_deinit(void)
{
 ...
 remove_proc_entry("qdma/self_test", ((void *)0));
