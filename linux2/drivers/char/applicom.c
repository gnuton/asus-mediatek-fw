...
/* $Id: applicom.c,v 1.1.2.1 2011/07/04 15:53:21 lino Exp $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: applicom.c,v 1.1.2.1 2011/07/04 15:53:21 lino Exp $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: 1.1.2.1 $)\n");
