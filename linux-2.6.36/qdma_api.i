# 1 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c" 2
...
struct dma_attrs;
# 5 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c" 2
...
# 6 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c" 2
...
# 7 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c" 2
...
# 9 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c" 2
...
# 13 "/proj/mtk04880/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/sockios.h"
...
# 14 "/proj/mtk04880/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/sockios.h" 2
...
# 10 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c" 2
# 19 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_init(QDMA_InitCfg_t *pInitCfg)
{
 int ret ;
...
extern typeof(qdma_init) qdma_init; static const char __kstrtab_qdma_init[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_init"; static const struct kernel_symbol __ksymtab_qdma_init __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_init, __kstrtab_qdma_init } ;
# 75 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_deinit(void)
{
...
extern typeof(qdma_deinit) qdma_deinit; static const char __kstrtab_qdma_deinit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_deinit"; static const struct kernel_symbol __ksymtab_qdma_deinit __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_deinit, __kstrtab_qdma_deinit } ;
# 103 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
void qdma_dma_mode(QDMA_Mode_t txMode, QDMA_Mode_t rxMode, QDMA_Mode_t hwFwdMode)
{
...
extern typeof(qdma_dma_mode) qdma_dma_mode; static const char __kstrtab_qdma_dma_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_dma_mode"; static const struct kernel_symbol __ksymtab_qdma_dma_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_dma_mode, __kstrtab_qdma_dma_mode } ;
...
void qdma_loopback_mode(QDMA_LoopbackMode_t lbMode)
{
 ...
 if(lbMode == QDMA_LOOPBACK_DISABLE) {
  { uint t = ioread32((void *)((base+0x0004))); iowrite32((t&~((1<<17))), (void *)((base+0x0004))); } ;
  { uint t = ioread32((void *)((base+0x0004))); iowrite32((t&~((1<<16))), (void *)((base+0x0004))); } ;
...
extern typeof(qdma_loopback_mode) qdma_loopback_mode; static const char __kstrtab_qdma_loopback_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_loopback_mode"; static const struct kernel_symbol __ksymtab_qdma_loopback_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_loopback_mode, __kstrtab_qdma_loopback_mode } ;
# 158 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_tx_delay(unchar txIrqThreshold, ushort txIrqPtime)
{
 uint base = gpQdmaPriv->csrBaseAddr ;
 ...
 { uint t = ioread32((void *)((base+0x0064))); iowrite32(((t&~((0xFFF<<(16))))|((txIrqThreshold<<(16))&(0xFFF<<(16)))), (void *)((base+0x0064))); } ;
 { uint t = ioread32((void *)((base+0x0070))); iowrite32(((t&~((0xFFFF<<(0))))|((txIrqPtime<<(0))&(0xFFFF<<(0)))), (void *)((base+0x0070))); } ;

 return 0 ;
}
extern typeof(qdma_set_tx_delay) qdma_set_tx_delay; static const char __kstrtab_qdma_set_tx_delay[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_tx_delay"; static const struct kernel_symbol __ksymtab_qdma_set_tx_delay __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_tx_delay, __kstrtab_qdma_set_tx_delay } ;
# 185 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_rx_delay(unchar rxMaxInt, unchar rxMaxPtime)
{
 uint base = gpQdmaPriv->csrBaseAddr ;

 if(rxMaxInt != 0) {
  iowrite32(((1<<15) | (rxMaxInt<<(8)) | (rxMaxPtime<<(0))), (void *)((base+0x0058))) ;
 } else {
  iowrite32(0, (void *)((base+0x0058))) ;
 }

 return 0 ;
}
extern typeof(qdma_set_rx_delay) qdma_set_rx_delay; static const char __kstrtab_qdma_set_rx_delay[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_rx_delay"; static const struct kernel_symbol __ksymtab_qdma_set_rx_delay __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_rx_delay, __kstrtab_qdma_set_rx_delay } ;
# 232 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_register_callback_function(QDMA_CbType_t type, void *pCbFun)
{
 uint base = gpQdmaPriv->csrBaseAddr ;
...
extern typeof(qdma_register_callback_function) qdma_register_callback_function; static const char __kstrtab_qdma_register_callback_function[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_register_callback_function"; static const struct kernel_symbol __ksymtab_qdma_register_callback_function __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_register_callback_function, __kstrtab_qdma_register_callback_function } ;
...
int qdma_unregister_callback_function(QDMA_CbType_t type)
{
 ...
 switch(type) {
  case QDMA_CALLBACK_TX_FINISHED:
   gpQdmaPriv->devCfg.bmXmitCallbackFunction = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_RX_PACKET:
   gpQdmaPriv->devCfg.bmRecvCallbackFunction = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_EVENT_HANDLER:
   gpQdmaPriv->devCfg.bmEventCallbackFunction = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_PTM_HANDLER :
   qdmaDisableInt(base, (1<<18)) ;
   gpQdmaPriv->devCfg.bmPtmIntHandler = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_SAR_HANDLER :
   qdmaDisableInt(base, (1<<19)) ;
   gpQdmaPriv->devCfg.bmSarIntHandler = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_GPON_MAC_HANDLER :
   qdmaDisableInt(base, (1<<16)) ;
   gpQdmaPriv->devCfg.bmGponMacIntHandler = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_EPON_MAC_HANDLER :
   qdmaDisableInt(base, (1<<17)) ;
   gpQdmaPriv->devCfg.bmEponMacIntHandler = ((void *)0) ;
   break ;

  case QDMA_CALLBACK_XPON_PHY_HANDLER :
   qdmaDisableInt(base, (1<<24)) ;
   gpQdmaPriv->devCfg.bmXponPhyIntHandler = ((void *)0) ;
   break ;
...
extern typeof(qdma_unregister_callback_function) qdma_unregister_callback_function; static const char __kstrtab_qdma_unregister_callback_function[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_unregister_callback_function"; static const struct kernel_symbol __ksymtab_qdma_unregister_callback_function __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_unregister_callback_function, __kstrtab_qdma_unregister_callback_function } ;
...
extern typeof(qdma_has_free_rxdscp) qdma_has_free_rxdscp; static const char __kstrtab_qdma_has_free_rxdscp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_has_free_rxdscp"; static const struct kernel_symbol __ksymtab_qdma_has_free_rxdscp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_has_free_rxdscp, __kstrtab_qdma_has_free_rxdscp } ;
...
extern typeof(qdma_hook_receive_buffer) qdma_hook_receive_buffer; static const char __kstrtab_qdma_hook_receive_buffer[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_hook_receive_buffer"; static const struct kernel_symbol __ksymtab_qdma_hook_receive_buffer __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_hook_receive_buffer, __kstrtab_qdma_hook_receive_buffer } ;
...
extern typeof(qdma_recycle_receive_buffer) qdma_recycle_receive_buffer; static const char __kstrtab_qdma_recycle_receive_buffer[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_recycle_receive_buffer"; static const struct kernel_symbol __ksymtab_qdma_recycle_receive_buffer __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_recycle_receive_buffer, __kstrtab_qdma_recycle_receive_buffer } ;
...
extern typeof(qdma_enable_rxpkt_int) qdma_enable_rxpkt_int; static const char __kstrtab_qdma_enable_rxpkt_int[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_enable_rxpkt_int"; static const struct kernel_symbol __ksymtab_qdma_enable_rxpkt_int __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_enable_rxpkt_int, __kstrtab_qdma_enable_rxpkt_int } ;
...
extern typeof(qdma_disable_rxpkt_int) qdma_disable_rxpkt_int; static const char __kstrtab_qdma_disable_rxpkt_int[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_disable_rxpkt_int"; static const struct kernel_symbol __ksymtab_qdma_disable_rxpkt_int __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_disable_rxpkt_int, __kstrtab_qdma_disable_rxpkt_int } ;
...
extern typeof(qdma_receive_packet_mode) qdma_receive_packet_mode; static const char __kstrtab_qdma_receive_packet_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_receive_packet_mode"; static const struct kernel_symbol __ksymtab_qdma_receive_packet_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_receive_packet_mode, __kstrtab_qdma_receive_packet_mode } ;
...
extern typeof(qdma_receive_packets) qdma_receive_packets; static const char __kstrtab_qdma_receive_packets[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_receive_packets"; static const struct kernel_symbol __ksymtab_qdma_receive_packets __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_receive_packets, __kstrtab_qdma_receive_packets } ;
...
extern typeof(qdma_transmit_packet) qdma_transmit_packet; static const char __kstrtab_qdma_transmit_packet[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_transmit_packet"; static const struct kernel_symbol __ksymtab_qdma_transmit_packet __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_transmit_packet, __kstrtab_qdma_transmit_packet } ;
# 471 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_txdscp_recycle_mode(QDMA_RecycleMode_t txMode)
{
 return qdma_bm_tx_polling_mode((txMode==QDMA_TX_POLLING)?QDMA_ENABLE:QDMA_DISABLE, 0) ;
}
# 489 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
extern typeof(qdma_txdscp_recycle_mode) qdma_txdscp_recycle_mode; static const char __kstrtab_qdma_txdscp_recycle_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_txdscp_recycle_mode"; static const struct kernel_symbol __ksymtab_qdma_txdscp_recycle_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_txdscp_recycle_mode, __kstrtab_qdma_txdscp_recycle_mode } ;
...
extern typeof(qdma_txdscp_recycle) qdma_txdscp_recycle; static const char __kstrtab_qdma_txdscp_recycle[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_txdscp_recycle"; static const struct kernel_symbol __ksymtab_qdma_txdscp_recycle __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_txdscp_recycle, __kstrtab_qdma_txdscp_recycle } ;
...
extern typeof(qdma_recycle_transmit_buffer) qdma_recycle_transmit_buffer; static const char __kstrtab_qdma_recycle_transmit_buffer[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_recycle_transmit_buffer"; static const struct kernel_symbol __ksymtab_qdma_recycle_transmit_buffer __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_recycle_transmit_buffer, __kstrtab_qdma_recycle_transmit_buffer } ;
# 529 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_tx_qos_weight(QDMA_TxQosWeightType_t weightBase, QDMA_TxQosWeightScale_t weightScale)
{
 uint base = gpQdmaPriv->csrBaseAddr ;

 if(weightBase == QDMA_TXQOS_WEIGHT_BY_PACKET) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32((t&~((1<<3))), (void *)((base+0x0080))); } ;
 } else if(weightBase == QDMA_TXQOS_WEIGHT_BY_BYTE) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32((t|(1<<3)), (void *)((base+0x0080))); } ;
  if(weightScale == QDMA_TXQOS_WEIGHT_SCALE_64B) {
   { uint t = ioread32((void *)((base+0x0080))); iowrite32((t&~((1<<31))), (void *)((base+0x0080))); } ;
...
extern typeof(qdma_set_tx_qos_weight) qdma_set_tx_qos_weight; static const char __kstrtab_qdma_set_tx_qos_weight[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_tx_qos_weight"; static const struct kernel_symbol __ksymtab_qdma_set_tx_qos_weight __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_tx_qos_weight, __kstrtab_qdma_set_tx_qos_weight } ;
# 560 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_get_tx_qos_weight(QDMA_TxQosWeightType_t *pWeightBase, QDMA_TxQosWeightScale_t *pWeightScale)
{
 uint base = gpQdmaPriv->csrBaseAddr ;

 if((ioread32((void *)((base+0x0080))) & (1<<3))) {
  *pWeightBase = QDMA_TXQOS_WEIGHT_BY_BYTE ;
 } else {
  *pWeightBase = QDMA_TXQOS_WEIGHT_BY_PACKET ;
 }

 if((ioread32((void *)((base+0x0080))) & (1<<31))) {
...
extern typeof(qdma_get_tx_qos_weight) qdma_get_tx_qos_weight; static const char __kstrtab_qdma_get_tx_qos_weight[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_tx_qos_weight"; static const struct kernel_symbol __ksymtab_qdma_get_tx_qos_weight __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_tx_qos_weight, __kstrtab_qdma_get_tx_qos_weight } ;
# 590 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_tx_qos(QDMA_TxQosScheduler_T *pTxQos)
{
 int i ;
 unchar weight[8] ;

 if(pTxQos->channel >= 16) {
  return -22 ;
 }
...
extern typeof(qdma_set_tx_qos) qdma_set_tx_qos; static const char __kstrtab_qdma_set_tx_qos[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_tx_qos"; static const struct kernel_symbol __ksymtab_qdma_set_tx_qos __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_tx_qos, __kstrtab_qdma_set_tx_qos } ;
# 624 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_get_tx_qos(QDMA_TxQosScheduler_T *pTxQos)
{
 int ret, i ;
 unchar qosType ;
...
extern typeof(qdma_get_tx_qos) qdma_get_tx_qos; static const char __kstrtab_qdma_get_tx_qos[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_tx_qos"; static const struct kernel_symbol __ksymtab_qdma_get_tx_qos __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_tx_qos, __kstrtab_qdma_get_tx_qos } ;
# 661 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_txbuf_threshold(QDMA_TxBufCtrl_T *pTxBufCtrl)
{
 uint base = gpQdmaPriv->csrBaseAddr ;

 if(pTxBufCtrl->mode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x0090))); iowrite32((t|(1<<31)), (void *)((base+0x0090))); } ;

  { uint t = ioread32((void *)((base+0x0090))); iowrite32(((t&~((0xFF<<(8))))|((pTxBufCtrl->chnThreshold<<(8))&(0xFF<<(8)))), (void *)((base+0x0090))); } ;
  { uint t = ioread32((void *)((base+0x0090))); iowrite32(((t&~((0xFF<<(0))))|((pTxBufCtrl->totalThreshold<<(0))&(0xFF<<(0)))), (void *)((base+0x0090))); } ;
...
extern typeof(qdma_set_txbuf_threshold) qdma_set_txbuf_threshold; static const char __kstrtab_qdma_set_txbuf_threshold[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_txbuf_threshold"; static const struct kernel_symbol __ksymtab_qdma_set_txbuf_threshold __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_txbuf_threshold, __kstrtab_qdma_set_txbuf_threshold } ;
# 830 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_epon_report_mode(unchar channel, QDMA_EponReportMode_t mode)
{
 if(channel >= 8) {
  return -22 ;
...
extern typeof(qdma_set_epon_report_mode) qdma_set_epon_report_mode; static const char __kstrtab_qdma_set_epon_report_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_epon_report_mode"; static const struct kernel_symbol __ksymtab_qdma_set_epon_report_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_epon_report_mode, __kstrtab_qdma_set_epon_report_mode } ;
...
extern typeof(qdma_get_epon_report_mode) qdma_get_epon_report_mode; static const char __kstrtab_qdma_get_epon_report_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_epon_report_mode"; static const struct kernel_symbol __ksymtab_qdma_get_epon_report_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_epon_report_mode, __kstrtab_qdma_get_epon_report_mode } ;
# 887 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_epon_queue_threshold(QDMA_EponQueueThreshold_T *pEponQThr)
{
...
extern typeof(qdma_set_epon_queue_threshold) qdma_set_epon_queue_threshold; static const char __kstrtab_qdma_set_epon_queue_threshold[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_epon_queue_threshold"; static const struct kernel_symbol __ksymtab_qdma_set_epon_queue_threshold __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_epon_queue_threshold, __kstrtab_qdma_set_epon_queue_threshold } ;
# 904 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_get_epon_queue_threshold(QDMA_EponQueueThreshold_T *pEponQThr)
{
 int ret ;
...
extern typeof(qdma_get_epon_queue_threshold) qdma_get_epon_queue_threshold; static const char __kstrtab_qdma_get_epon_queue_threshold[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_epon_queue_threshold"; static const struct kernel_symbol __ksymtab_qdma_get_epon_queue_threshold __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_epon_queue_threshold, __kstrtab_qdma_get_epon_queue_threshold } ;
# 930 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_channel_retire(uint channel)
{
 if(channel >= 16) {
  return -22 ;
...
extern typeof(qdma_set_channel_retire) qdma_set_channel_retire; static const char __kstrtab_qdma_set_channel_retire[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_channel_retire"; static const struct kernel_symbol __ksymtab_qdma_set_channel_retire __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_channel_retire, __kstrtab_qdma_set_channel_retire } ;
...
int qdma_set_tx_channel_retire_mask(uint channel, QDMA_Mode_t maskMode)
{
 ...
 if(maskMode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x0044))); iowrite32((t|(1<<((0)+channel))), (void *)((base+0x0044))); } ;
 } else {
  { uint t = ioread32((void *)((base+0x0044))); iowrite32((t&~((1<<((0)+channel)))), (void *)((base+0x0044))); } ;
 }
...
extern typeof(qdma_set_tx_channel_retire_mask) qdma_set_tx_channel_retire_mask; static const char __kstrtab_qdma_set_tx_channel_retire_mask[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_tx_channel_retire_mask"; static const struct kernel_symbol __ksymtab_qdma_set_tx_channel_retire_mask __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_tx_channel_retire_mask, __kstrtab_qdma_set_tx_channel_retire_mask } ;
# 972 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
void qdma_set_prefetch_mode(QDMA_Mode_t prefecthMode)
{
 uint base = gpQdmaPriv->csrBaseAddr ;

 if(prefecthMode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x008C))); iowrite32((t|(1<<0)), (void *)((base+0x008C))); } ;
 } else {
  { uint t = ioread32((void *)((base+0x008C))); iowrite32((t&~((1<<0))), (void *)((base+0x008C))); } ;
 }
}
extern typeof(qdma_set_prefetch_mode) qdma_set_prefetch_mode; static const char __kstrtab_qdma_set_prefetch_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_prefetch_mode"; static const struct kernel_symbol __ksymtab_qdma_set_prefetch_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_prefetch_mode, __kstrtab_qdma_set_prefetch_mode } ;
...
void qdma_set_txqueue_trtcm_mode(QDMA_Mode_t trtcmMode)
{
 ...
 if(trtcmMode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x00A0))); iowrite32((t|(1<<31)), (void *)((base+0x00A0))); } ;
 } else {
  { uint t = ioread32((void *)((base+0x00A0))); iowrite32((t&~((1<<31))), (void *)((base+0x00A0))); } ;
 }
}
extern typeof(qdma_set_txqueue_trtcm_mode) qdma_set_txqueue_trtcm_mode; static const char __kstrtab_qdma_set_txqueue_trtcm_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_txqueue_trtcm_mode"; static const struct kernel_symbol __ksymtab_qdma_set_txqueue_trtcm_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_txqueue_trtcm_mode, __kstrtab_qdma_set_txqueue_trtcm_mode } ;
...
QDMA_Mode_t qdma_get_txqueue_trtcm_mode(void)
{
 ...
 if((ioread32((void *)((base+0x00A0))) & (1<<31))) {
  return QDMA_ENABLE ;
 } else {
  return QDMA_DISABLE ;
 }
}
extern typeof(qdma_get_txqueue_trtcm_mode) qdma_get_txqueue_trtcm_mode; static const char __kstrtab_qdma_get_txqueue_trtcm_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_txqueue_trtcm_mode"; static const struct kernel_symbol __ksymtab_qdma_get_txqueue_trtcm_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_txqueue_trtcm_mode, __kstrtab_qdma_get_txqueue_trtcm_mode } ;
...
void qdma_set_txqueue_dei_mode(QDMA_Mode_t deiDropMode)
{
 ...
 if(deiDropMode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x00A0))); iowrite32((t|(1<<30)), (void *)((base+0x00A0))); } ;
 } else {
  { uint t = ioread32((void *)((base+0x00A0))); iowrite32((t&~((1<<30))), (void *)((base+0x00A0))); } ;
 }
}
extern typeof(qdma_set_txqueue_dei_mode) qdma_set_txqueue_dei_mode; static const char __kstrtab_qdma_set_txqueue_dei_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_txqueue_dei_mode"; static const struct kernel_symbol __ksymtab_qdma_set_txqueue_dei_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_txqueue_dei_mode, __kstrtab_qdma_set_txqueue_dei_mode } ;
...
QDMA_Mode_t qdma_get_txqueue_dei_mode(void)
{
 ...
 if((ioread32((void *)((base+0x00A0))) & (1<<30))) {
  return QDMA_ENABLE ;
 } else {
  return QDMA_DISABLE ;
 }
}
extern typeof(qdma_get_txqueue_dei_mode) qdma_get_txqueue_dei_mode; static const char __kstrtab_qdma_get_txqueue_dei_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_txqueue_dei_mode"; static const struct kernel_symbol __ksymtab_qdma_get_txqueue_dei_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_txqueue_dei_mode, __kstrtab_qdma_get_txqueue_dei_mode } ;
...
void qdma_set_txqueue_threshold_mode(QDMA_Mode_t thrsldDropMode)
{
 ...
 if(thrsldDropMode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x00A0))); iowrite32((t|(1<<29)), (void *)((base+0x00A0))); } ;
 } else {
  { uint t = ioread32((void *)((base+0x00A0))); iowrite32((t&~((1<<29))), (void *)((base+0x00A0))); } ;
 }
}
extern typeof(qdma_set_txqueue_threshold_mode) qdma_set_txqueue_threshold_mode; static const char __kstrtab_qdma_set_txqueue_threshold_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_txqueue_threshold_mode"; static const struct kernel_symbol __ksymtab_qdma_set_txqueue_threshold_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_txqueue_threshold_mode, __kstrtab_qdma_set_txqueue_threshold_mode } ;
...
QDMA_Mode_t qdma_get_txqueue_threshold_mode(void)
{
 ...
 if((ioread32((void *)((base+0x00A0))) & (1<<29))) {
  return QDMA_ENABLE ;
 } else {
  return QDMA_DISABLE ;
 }
}
extern typeof(qdma_get_txqueue_threshold_mode) qdma_get_txqueue_threshold_mode; static const char __kstrtab_qdma_get_txqueue_threshold_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_txqueue_threshold_mode"; static const struct kernel_symbol __ksymtab_qdma_get_txqueue_threshold_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_txqueue_threshold_mode, __kstrtab_qdma_get_txqueue_threshold_mode } ;
# 1094 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_congestion_scale(QDMA_TxQueueCongestScale_T *pScale)
{
...
extern typeof(qdma_set_congestion_scale) qdma_set_congestion_scale; static const char __kstrtab_qdma_set_congestion_scale[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_congestion_scale"; static const struct kernel_symbol __ksymtab_qdma_set_congestion_scale __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_congestion_scale, __kstrtab_qdma_set_congestion_scale } ;
# 1114 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_congest_drop_probability(QDMA_TxQueueDropProbability_T *pProbability)
{
...
extern typeof(qdma_set_congest_drop_probability) qdma_set_congest_drop_probability; static const char __kstrtab_qdma_set_congest_drop_probability[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_congest_drop_probability"; static const struct kernel_symbol __ksymtab_qdma_set_congest_drop_probability __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_congest_drop_probability, __kstrtab_qdma_set_congest_drop_probability } ;
# 1136 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_congest_threshold(QDMA_TxQueueCongestThreshold_T *pThreshold)
{
 unchar threshold[8] ;
 int ret = 0 ;

 if(pThreshold->queueIdx<0 || pThreshold->queueIdx>=8) {
  return -22 ;
 }
...
extern typeof(qdma_set_congest_threshold) qdma_set_congest_threshold; static const char __kstrtab_qdma_set_congest_threshold[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_congest_threshold"; static const struct kernel_symbol __ksymtab_qdma_set_congest_threshold __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_congest_threshold, __kstrtab_qdma_set_congest_threshold } ;
...
extern typeof(qdma_get_congest_config) qdma_get_congest_config; static const char __kstrtab_qdma_get_congest_config[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_congest_config"; static const struct kernel_symbol __ksymtab_qdma_get_congest_config __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_congest_config, __kstrtab_qdma_get_congest_config } ;
# 1260 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_txqueue_trtcm_scale(QDMA_TrtcmScale_t trtcmScale)
{
...
extern typeof(qdma_set_txqueue_trtcm_scale) qdma_set_txqueue_trtcm_scale; static const char __kstrtab_qdma_set_txqueue_trtcm_scale[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_txqueue_trtcm_scale"; static const struct kernel_symbol __ksymtab_qdma_set_txqueue_trtcm_scale __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_txqueue_trtcm_scale, __kstrtab_qdma_set_txqueue_trtcm_scale } ;
...
extern typeof(qdma_get_txqueue_trtcm_scale) qdma_get_txqueue_trtcm_scale; static const char __kstrtab_qdma_get_txqueue_trtcm_scale[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_txqueue_trtcm_scale"; static const struct kernel_symbol __ksymtab_qdma_get_txqueue_trtcm_scale __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_txqueue_trtcm_scale, __kstrtab_qdma_get_txqueue_trtcm_scale } ;
# 1292 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_txqueue_trtcm_params(QDMA_TxQueueTrtcm_T *pTxQueueTrtcm)
{
 int ret = 0 ;
...
extern typeof(qdma_set_txqueue_trtcm_params) qdma_set_txqueue_trtcm_params; static const char __kstrtab_qdma_set_txqueue_trtcm_params[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_txqueue_trtcm_params"; static const struct kernel_symbol __ksymtab_qdma_set_txqueue_trtcm_params __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_txqueue_trtcm_params, __kstrtab_qdma_set_txqueue_trtcm_params } ;
# 1323 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_get_txqueue_trtcm_params(QDMA_TxQueueTrtcm_T *pTxQueueTrtcm)
{
 int value ;
...
extern typeof(qdma_get_txqueue_trtcm_params) qdma_get_txqueue_trtcm_params; static const char __kstrtab_qdma_get_txqueue_trtcm_params[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_txqueue_trtcm_params"; static const struct kernel_symbol __ksymtab_qdma_get_txqueue_trtcm_params __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_txqueue_trtcm_params, __kstrtab_qdma_get_txqueue_trtcm_params } ;
...
void qdma_set_gpon_trtcm_mode(QDMA_Mode_t trtcmMode)
{
 ...
 if(trtcmMode == QDMA_ENABLE) {
  { uint t = ioread32((void *)((base+0x00C0))); iowrite32((t|(1<<31)), (void *)((base+0x00C0))); } ;
 } else {
  { uint t = ioread32((void *)((base+0x00C0))); iowrite32((t&~((1<<31))), (void *)((base+0x00C0))); } ;
 }
}
extern typeof(qdma_set_gpon_trtcm_mode) qdma_set_gpon_trtcm_mode; static const char __kstrtab_qdma_set_gpon_trtcm_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_gpon_trtcm_mode"; static const struct kernel_symbol __ksymtab_qdma_set_gpon_trtcm_mode __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_gpon_trtcm_mode, __kstrtab_qdma_set_gpon_trtcm_mode } ;
# 1379 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_gpon_trtcm_scale(QDMA_TrtcmScale_t trtcmScale)
{
 if(trtcmScale<0 || trtcmScale>=QDMA_TRTCM_SCALE_MAX_ITEMS) {
  return -22 ;
...
extern typeof(qdma_set_gpon_trtcm_scale) qdma_set_gpon_trtcm_scale; static const char __kstrtab_qdma_set_gpon_trtcm_scale[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_gpon_trtcm_scale"; static const struct kernel_symbol __ksymtab_qdma_set_gpon_trtcm_scale __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_gpon_trtcm_scale, __kstrtab_qdma_set_gpon_trtcm_scale } ;
# 1401 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_set_gpon_trtcm_params(QDMA_TcontTrtcm_T *pTcontTrtcm)
{
 int ret = 0 ;
...
extern typeof(qdma_set_gpon_trtcm_params) qdma_set_gpon_trtcm_params; static const char __kstrtab_qdma_set_gpon_trtcm_params[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_set_gpon_trtcm_params"; static const struct kernel_symbol __ksymtab_qdma_set_gpon_trtcm_params __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_set_gpon_trtcm_params, __kstrtab_qdma_set_gpon_trtcm_params } ;
# 1434 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_get_gpon_trtcm_params(QDMA_TcontTrtcm_T *pTcontTrtcm)
{
 int ret = 0 ;
...
extern typeof(qdma_get_gpon_trtcm_params) qdma_get_gpon_trtcm_params; static const char __kstrtab_qdma_get_gpon_trtcm_params[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_get_gpon_trtcm_params"; static const struct kernel_symbol __ksymtab_qdma_get_gpon_trtcm_params __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_get_gpon_trtcm_params, __kstrtab_qdma_get_gpon_trtcm_params } ;
# 1474 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_api.c"
int qdma_pse_set_pcp_config(PSE_PcpType_t pcpType, PSE_PcpMode_t pcpMode)
{
...
extern typeof(qdma_pse_set_pcp_config) qdma_pse_set_pcp_config; static const char __kstrtab_qdma_pse_set_pcp_config[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_pse_set_pcp_config"; static const struct kernel_symbol __ksymtab_qdma_pse_set_pcp_config __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_pse_set_pcp_config, __kstrtab_qdma_pse_set_pcp_config } ;
...
extern typeof(qdma_pse_get_pcp_config) qdma_pse_get_pcp_config; static const char __kstrtab_qdma_pse_get_pcp_config[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "qdma_pse_get_pcp_config"; static const struct kernel_symbol __ksymtab_qdma_pse_get_pcp_config __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&qdma_pse_get_pcp_config, __kstrtab_qdma_pse_get_pcp_config } ;
