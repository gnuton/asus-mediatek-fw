/*
 * $Id: musycc.c,v 1.1.2.1 2011/07/04 16:10:54 lino Exp $
 */
 ...
 * Last changed on $Date: 2011/07/04 16:10:54 $
 * Changed by $Author: lino $
 *-----------------------------------------------------------------------------
 * $Log: musycc.c,v $
 * Revision 1.1.2.1  2011/07/04 16:10:54  lino
 * new kernel 2.6.36
 *
...
"@(#)musycc.c - $Revision: 1.1.2.1 $      (c) Copyright 2004-2006 SBE, Inc.";
