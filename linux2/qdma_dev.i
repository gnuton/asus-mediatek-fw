# 1 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
...
struct dma_attrs;
# 5 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
...
# 6 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
...
# 7 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
...
# 8 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
...
# 10 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
...
# 11 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c" 2
# 20 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c"
static int __pseChannelRelease(unchar channel)
{
 ...
 chnRelease = ((1<<0) | ((channel<<(4))&(0xF<<(4)))) ;
 iowrite32(chnRelease, (void *)(regAddr)) ;

 while(RETRY--) {
  chnRelease = ioread32((void *)(regAddr)) ;
  { if(gpQdmaPriv->devCfg.dbgLevel >= DEG_MSG) printk("%s [%d]: " "Read PSE Channel Release: %.8x\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 31, chnRelease) ; } ;
  if(chnRelease&(1<<1)) {

   chnRelease = ((channel<<(4))&(0xF<<(4))) ;
   iowrite32(chnRelease, (void *)(regAddr)) ;
   { if(gpQdmaPriv->devCfg.dbgLevel >= DEG_MSG) printk("%s [%d]: " "Write PSE Channel Release: %.8x\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 36, chnRelease) ; } ;
   break ;
  }
  ( (__builtin_constant_p(5) && (5)<=5) ? __udelay((5)*1000) : ({unsigned long __ms=(5); while (__ms--) __udelay(1000);})) ;
 }
 if(RETRY < 0) {
  printk("%s [%d]: " "Timeout for GDM2 channel release, channel:%d.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 42, channel) ;
  return -62 ;
 }
 return 0 ;
}
# 56 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c"
int __inline__ __attribute__((always_inline)) pseSetWanPcpConfig(unchar type, unchar mode)
{
 uint regAddr = 0xBFB51514 ;

 if(type == 0) {
  { uint t = ioread32((void *)(regAddr)); iowrite32(((t&~((0xF<<(0))))|((mode<<(0))&(0xF<<(0)))), (void *)(regAddr)); } ;
 } else if(type == 1) {
  { uint t = ioread32((void *)(regAddr)); iowrite32(((t&~((0xF<<(4))))|((mode<<(4))&(0xF<<(4)))), (void *)(regAddr)); } ;
 } else if(type == 2) {
  { uint t = ioread32((void *)(regAddr)); iowrite32(((t&~((0xF<<(8))))|((mode<<(8))&(0xF<<(8)))), (void *)(regAddr)); } ;
 }
...
int __inline__ __attribute__((always_inline)) pseGetWanPcpConfig(unchar type)
{
 ...
 if(type == 0) {
  pcpMode = ((ioread32((void *)(regAddr)) & (0xF<<(0))) >> (0)) ;
 } else if(type == 1) {
  pcpMode = ((ioread32((void *)(regAddr)) & (0xF<<(4))) >> (4)) ;
 } else if(type == 2) {
  pcpMode = ((ioread32((void *)(regAddr)) & (0xF<<(8))) >> (8)) ;
 }
...
int __inline__ __attribute__((always_inline)) qdmaSetChannelRetire(unchar channel)
{
 ...
 chnRetire = ((1<<31) | ((channel<<(0))&(0xF<<(0)))) ;
 iowrite32(chnRetire, (void *)((base+0x0040))) ;
 while(RETRY--) {
  chnRetire = ioread32((void *)((base+0x0040))) ;
  { if(gpQdmaPriv->devCfg.dbgLevel >= DEG_MSG) printk("%s [%d]: " "Read QDMA Channel Release: %.8x\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 109, chnRetire) ; } ;
  if(chnRetire&(1<<30)) {

   chnRetire = ((channel<<(0))&(0xF<<(0))) ;
   iowrite32(chnRetire, (void *)((base+0x0040))) ;
   { if(gpQdmaPriv->devCfg.dbgLevel >= DEG_MSG) printk("%s [%d]: " "Set QDMA Channel Release: %.8x\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 114, chnRetire) ; } ;
   break ;
  }
  ( (__builtin_constant_p(5) && (5)<=5) ? __udelay((5)*1000) : ({unsigned long __ms=(5); while (__ms--) __udelay(1000);})) ;
 }
 if(RETRY < 0) {
  printk("%s [%d]: " "Timeout for channel retire, channel:%d.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 120, channel) ;
  ret = -62 ;
 }
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQosScheduler(unchar channel, unchar mode, unchar weight[8])
{
 ...
 if(channel == 0) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(0))))|((mode<<(0))&(0x7<<(0)))), (void *)((base+0x0080))); } ;
 } else if(channel == 1) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(4))))|((mode<<(4))&(0x7<<(4)))), (void *)((base+0x0080))); } ;
 } else if(channel == 2) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(8))))|((mode<<(8))&(0x7<<(8)))), (void *)((base+0x0080))); } ;
 } else if(channel == 3) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(12))))|((mode<<(12))&(0x7<<(12)))), (void *)((base+0x0080))); } ;
 } else if(channel == 4) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(16))))|((mode<<(16))&(0x7<<(16)))), (void *)((base+0x0080))); } ;
 } else if(channel == 5) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(20))))|((mode<<(20))&(0x7<<(20)))), (void *)((base+0x0080))); } ;
 } else if(channel == 6) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(24))))|((mode<<(24))&(0x7<<(24)))), (void *)((base+0x0080))); } ;
 } else if(channel == 7) {
  { uint t = ioread32((void *)((base+0x0080))); iowrite32(((t&~((0x7<<(28))))|((mode<<(28))&(0x7<<(28)))), (void *)((base+0x0080))); } ;
 } else if(channel == 8) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(0))))|((mode<<(0))&(0x7<<(0)))), (void *)((base+0x0084))); } ;
 } else if(channel == 9) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(4))))|((mode<<(4))&(0x7<<(4)))), (void *)((base+0x0084))); } ;
 } else if(channel == 10) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(8))))|((mode<<(8))&(0x7<<(8)))), (void *)((base+0x0084))); } ;
 } else if(channel == 11) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(12))))|((mode<<(12))&(0x7<<(12)))), (void *)((base+0x0084))); } ;
 } else if(channel == 12) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(16))))|((mode<<(16))&(0x7<<(16)))), (void *)((base+0x0084))); } ;
 } else if(channel == 13) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(20))))|((mode<<(20))&(0x7<<(20)))), (void *)((base+0x0084))); } ;
 } else if(channel == 14) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(24))))|((mode<<(24))&(0x7<<(24)))), (void *)((base+0x0084))); } ;
 } else if(channel == 15) {
  { uint t = ioread32((void *)((base+0x0084))); iowrite32(((t&~((0x7<<(28))))|((mode<<(28))&(0x7<<(28)))), (void *)((base+0x0084))); } ;
 }
 ...
 for(i=0 ; i<8 ; i++) {
  if(weight[i] != 255) {
   wrrCfg = ((1<<31) |
       ...
       ((channel<<(3))&(0xF<<(3))) |
       ((i<<(0))&(0x7<<(0)))) ;
   iowrite32(wrrCfg, (void *)((base+0x0088))) ;

   RETRY = 3 ;
   while(RETRY--) {
    wrrCfg = ioread32((void *)((base+0x0088))) ;
   ...
   if(RETRY < 0) {
    printk("%s [%d]: " "Timeout for setting WRR configuration, channel:%d, queue:%d.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 192, channel, i) ;
    return -62 ;
   }
  }
 }
...
int __inline__ __attribute__((always_inline)) qdmaGetTxQosScheduler(unchar channel, unchar *pMode, unchar weight[8])
{
 ...
 if(channel == 0) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(0))) >> (0)) ;
 } else if(channel == 1) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(4))) >> (4)) ;
 } else if(channel == 2) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(8))) >> (8)) ;
 } else if(channel == 3) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(12))) >> (12)) ;
 } else if(channel == 4) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(16))) >> (16)) ;
 } else if(channel == 5) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(20))) >> (20)) ;
 } else if(channel == 6) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(24))) >> (24)) ;
 } else if(channel == 7) {
  *pMode = ((ioread32((void *)((base+0x0080))) & (0x7<<(28))) >> (28)) ;
 } else if(channel == 8) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(0))) >> (0)) ;
 } else if(channel == 9) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(4))) >> (4)) ;
 } else if(channel == 10) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(8))) >> (8)) ;
 } else if(channel == 11) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(12))) >> (12)) ;
 } else if(channel == 12) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(16))) >> (16)) ;
 } else if(channel == 13) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(20))) >> (20)) ;
 } else if(channel == 14) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(24))) >> (24)) ;
 } else if(channel == 15) {
  *pMode = ((ioread32((void *)((base+0x0084))) & (0x7<<(28))) >> (28)) ;
 }

 for(i=0 ; i<8 ; i++) {
  wrrCfg = (((channel<<(3))&(0xF<<(3))) |
      ((i<<(0))&(0x7<<(0)))) ;
  iowrite32(wrrCfg, (void *)((base+0x0088))) ;
  ...
  while(RETRY--) {
   ...
   if(wrrCfg&(1<<30)) {
    weight[i] = ((wrrCfg&(0xFF<<(8)))>>(8)) ;
    break ;
   }
   ( (__builtin_constant_p(1) && (1)<=5) ? __udelay((1)*1000) : ({unsigned long __ms=(1); while (__ms--) __udelay(1000);})) ;
  }
  if(RETRY < 0) {
   printk("%s [%d]: " "Timeout for getting WRR configuration, channel:%d, queue:%d.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 260, channel, i) ;
   return -62 ;
  }
 }
 return 0 ;
}
# 326 "/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c"
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueCngsScale(unchar maxScale, unchar minScale)
{
 uint base = gpQdmaPriv->csrBaseAddr ;
 uint txqCngsCfg = 0 ;

 txqCngsCfg = ioread32((void *)((base+0x00A0))) ;
 txqCngsCfg = (txqCngsCfg&~(0x3<<(26))) | ((maxScale<<(26))&(0x3<<(26))) ;
 txqCngsCfg = (txqCngsCfg&~(0x3<<(24))) | ((minScale<<(24))&(0x3<<(24))) ;

 iowrite32(txqCngsCfg, (void *)((base+0x00A0))) ;
 ...
 *pMaxScale = (txqCngsCfg & (0x3<<(26))) >> (26) ;
 *pMinScale = (txqCngsCfg & (0x3<<(24))) >> (24) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueDropProbability(unchar grnDrop, unchar ylwDrop)
{
 ...
 txqCngsCfg = ioread32((void *)((base+0x00A0))) ;
 txqCngsCfg = (txqCngsCfg&~(0xFF<<(8))) | ((ylwDrop<<(8))&(0xFF<<(8))) ;
 txqCngsCfg = (txqCngsCfg&~(0xFF<<(0))) | ((grnDrop<<(0))&(0xFF<<(0))) ;
 ...
 *pYlwDrop = (txqCngsCfg & (0xFF<<(8))) >> (8) ;
 *pGrnDrop = (txqCngsCfg & (0xFF<<(0))) >> (0) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueGreenMaxThreshold(unchar txqIdx[8])
{
 ...
 iowrite32(grnMaxCfg, (void *)((base+0x00A4))) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetTxQueueGreenMaxThreshold(unchar txqIdx[8])
{
 ...
 grnMaxCfg = ioread32((void *)((base+0x00A4))) ;
 txqIdx[0] = ((grnMaxCfg & (0xF<<(0))) >> (0)) ;
 txqIdx[1] = ((grnMaxCfg & (0xF<<(4))) >> (4)) ;
 txqIdx[2] = ((grnMaxCfg & (0xF<<(8))) >> (8)) ;
 txqIdx[3] = ((grnMaxCfg & (0xF<<(12))) >> (12)) ;
 txqIdx[4] = ((grnMaxCfg & (0xF<<(16))) >> (16)) ;
 txqIdx[5] = ((grnMaxCfg & (0xF<<(20))) >> (20)) ;
 txqIdx[6] = ((grnMaxCfg & (0xF<<(24))) >> (24)) ;
 txqIdx[7] = ((grnMaxCfg & (0xF<<(28))) >> (28)) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueGreenMinThreshold(unchar txqIdx[8])
{
 ...
 iowrite32(grnMinCfg, (void *)((base+0x00A8))) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetTxQueueGreenMinThreshold(unchar txqIdx[8])
{
 ...
 grnMinCfg = ioread32((void *)((base+0x00A8))) ;
 txqIdx[0] = ((grnMinCfg & (0xF<<(0))) >> (0)) ;
 txqIdx[1] = ((grnMinCfg & (0xF<<(4))) >> (4)) ;
 txqIdx[2] = ((grnMinCfg & (0xF<<(8))) >> (8)) ;
 txqIdx[3] = ((grnMinCfg & (0xF<<(12))) >> (12)) ;
 txqIdx[4] = ((grnMinCfg & (0xF<<(16))) >> (16)) ;
 txqIdx[5] = ((grnMinCfg & (0xF<<(20))) >> (20)) ;
 txqIdx[6] = ((grnMinCfg & (0xF<<(24))) >> (24)) ;
 txqIdx[7] = ((grnMinCfg & (0xF<<(28))) >> (28)) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueYellowMaxThreshold(unchar txqIdx[8])
{
 ...
 iowrite32(ylwMaxCfg, (void *)((base+0x00AC))) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetTxQueueYellowMaxThreshold(unchar txqIdx[8])
{
 ...
 ylwMaxCfg = ioread32((void *)((base+0x00AC))) ;
 txqIdx[0] = ((ylwMaxCfg & (0xF<<(0))) >> (0)) ;
 txqIdx[1] = ((ylwMaxCfg & (0xF<<(4))) >> (4)) ;
 txqIdx[2] = ((ylwMaxCfg & (0xF<<(8))) >> (8)) ;
 txqIdx[3] = ((ylwMaxCfg & (0xF<<(12))) >> (12)) ;
 txqIdx[4] = ((ylwMaxCfg & (0xF<<(16))) >> (16)) ;
 txqIdx[5] = ((ylwMaxCfg & (0xF<<(20))) >> (20)) ;
 txqIdx[6] = ((ylwMaxCfg & (0xF<<(24))) >> (24)) ;
 txqIdx[7] = ((ylwMaxCfg & (0xF<<(28))) >> (28)) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueYellowMinThreshold(unchar txqIdx[8])
{
 ...
 iowrite32(ylwMinCfg, (void *)((base+0x00B0))) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetTxQueueYellowMinThreshold(unchar txqIdx[8])
{
 ...
 ylwMinCfg = ioread32((void *)((base+0x00B0))) ;
 txqIdx[0] = ((ylwMinCfg & (0xF<<(0))) >> (0)) ;
 txqIdx[1] = ((ylwMinCfg & (0xF<<(4))) >> (4)) ;
 txqIdx[2] = ((ylwMinCfg & (0xF<<(8))) >> (8)) ;
 txqIdx[3] = ((ylwMinCfg & (0xF<<(12))) >> (12)) ;
 txqIdx[4] = ((ylwMinCfg & (0xF<<(16))) >> (16)) ;
 txqIdx[5] = ((ylwMinCfg & (0xF<<(20))) >> (20)) ;
 txqIdx[6] = ((ylwMinCfg & (0xF<<(24))) >> (24)) ;
 txqIdx[7] = ((ylwMinCfg & (0xF<<(28))) >> (28)) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetTxQueueTrtcmConfig(unchar idx, unchar type, unchar scale, ushort value)
{
 ...
 trtcmCfg = ((1<<31) |
    ...
    ((idx<<(2))&(0x1F<<(2))) |
    ((type<<(0))&(0x3<<(0)))) ;
 iowrite32(trtcmCfg, (void *)((base+0x00B4))) ;

 while(RETRY--) {
  trtcmCfg = ioread32((void *)((base+0x00B4))) ;
 ...
 printk("%s [%d]: " "Timeout for set tx queue trTCM configuration.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 574) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetTxQueueTrtcmConfig(unchar idx, unchar scale, unchar type)
{
 ...
 while(RETRY--) {
  ...
  if(trtcmCfg&(1<<30)) {
   return ((trtcmCfg&(0xFFFF<<(8)))>>(8)) ;
  }
  ( (__builtin_constant_p(1) && (1)<=5) ? __udelay((1)*1000) : ({unsigned long __ms=(1); while (__ms--) __udelay(1000);})) ;
 }

 printk("%s [%d]: " "Timeout for get tx queue trTCM configuration.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 601) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetGponTrtcmConfig(unchar channel, unchar type, unchar scale, ushort value)
{
 ...
 trtcmCfg = ((1<<31) |
    ...
    ((channel<<(2))&(0xF<<(2))) |
    ((type<<(0))&(0x3<<(0)))) ;
 iowrite32(trtcmCfg, (void *)((base+0x00C4))) ;

 while(RETRY--) {
  trtcmCfg = ioread32((void *)((base+0x00C4))) ;
 ...
 printk("%s [%d]: " "Timeout for set GPON trTCM configuration.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 630) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetGponTrtcmConfig(unchar channel, unchar type)
{
 ...
 printk("%s [%d]: " "Timeout for get GPON trTCM configuration.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 656) ;
...
int __inline__ __attribute__((always_inline)) qdmaSetEponReportConfig(unchar channel, unchar mode)
{
 ...
 if(channel == 0) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(0))))|((mode<<(0))&(0x3<<(0)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 1) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(2))))|((mode<<(2))&(0x3<<(2)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 2) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(4))))|((mode<<(4))&(0x3<<(4)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 3) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(6))))|((mode<<(6))&(0x3<<(6)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 4) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(8))))|((mode<<(8))&(0x3<<(8)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 5) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(10))))|((mode<<(10))&(0x3<<(10)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 6) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(12))))|((mode<<(12))&(0x3<<(12)))), (void *)((base+0x00D0))); } ;
 } else if(channel == 7) {
  { uint t = ioread32((void *)((base+0x00D0))); iowrite32(((t&~((0x3<<(14))))|((mode<<(14))&(0x3<<(14)))), (void *)((base+0x00D0))); } ;
 }
...
int __inline__ __attribute__((always_inline)) qdmaGetEponReportConfig(unchar channel, unchar *pMode)
{
 ...
 if(channel == 0) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(0))) >> (0)) ;
 } else if(channel == 1) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(2))) >> (2)) ;
 } else if(channel == 2) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(4))) >> (4)) ;
 } else if(channel == 3) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(6))) >> (6)) ;
 } else if(channel == 4) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(8))) >> (8)) ;
 } else if(channel == 5) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(10))) >> (10)) ;
 } else if(channel == 6) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(12))) >> (12)) ;
 } else if(channel == 7) {
  *pMode = ((ioread32((void *)((base+0x00D0))) & (0x3<<(14))) >> (14)) ;
 }
...
int __inline__ __attribute__((always_inline)) qdmaSetEponThreshold(unchar channel, unchar queue, unchar type, ushort value)
{
 ...
 eponThresholdCfg = ((1<<31) |
    ...
    ((channel<<(3))&(0x7<<(3))) |
    ((queue<<(0))&(0x7<<(0)))) ;
 iowrite32(eponThresholdCfg, (void *)((base+0x00D4))) ;

 while(RETRY--) {
  eponThresholdCfg = ioread32((void *)((base+0x00D4))) ;
 ...
 printk("%s [%d]: " "Timeout for set EPON Threshold configuration.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 740) ;
...
int __inline__ __attribute__((always_inline)) qdmaGetEponThreshold(unchar channel, unchar queue, unchar type)
{
 ...
 while(RETRY--) {
  ...
  if(eponThresholdCfg&(1<<30)) {
   return ((eponThresholdCfg&(0xFFFF<<(8)))>>(8)) ;
  }
  ( (__builtin_constant_p(1) && (1)<=5) ? __udelay((1)*1000) : ({unsigned long __ms=(1); while (__ms--) __udelay(1000);})) ;
 }

 printk("%s [%d]: " "Timeout for get EPON Threshold configuration.\n", strrchr("/proj/mtk04880/tclinux_phoenix/modules/private/bufmgr/qdma_dev.c", '/')+1, 767) ;
...
int qdmaEnableInt(uint base, uint bit)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&gpQdmaPriv->irqLock)); } while (0); } while (0) ;


 while(RETRY--) {
  t = ioread32((void *)((base+0x0054))) ;
  if(t == 0) {
   printk("########WARNING: Enable INT: Get INT_ENABLE:%.8x, RETRY:%d\n", t, 3-RETRY) ;
  } else {
   iowrite32((t|bit), (void *)((base+0x0054))) ;
   break ;
  }
 }
...
int qdmaSetIntMask(uint base, uint value)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&gpQdmaPriv->irqLock)); } while (0); } while (0) ;
 iowrite32(value, (void *)((base+0x0054))) ;
 spin_unlock_irqrestore(&gpQdmaPriv->irqLock, flags) ;
...
int qdmaGetIntMask(uint base)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&gpQdmaPriv->irqLock)); } while (0); } while (0);
 value = ioread32((void *)((base+0x0054))) ;
 spin_unlock_irqrestore(&gpQdmaPriv->irqLock, flags);
...
int qdma_dev_init(void)
{
 ...
 intEnable = ((1<<13) | (1<<12) | (1<<9) | (1<<8) | (1<<3) | (1<<1) | (1<<0)) ;
 qdmaSetIntMask(base, intEnable) ;




 glbCfg |= ((1<<27) | (1<<26) | (((0x3)<<(4))&(0x3<<(4)))) ;
 ...
 iowrite32(glbCfg, (void *)((base+0x0004))) ;
